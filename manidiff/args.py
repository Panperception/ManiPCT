...
def add_args(parser):
    ...
    parser.add_argument('--cates', type=str, nargs='+', default=["car"],
                        help="Categories to be trained (useful only if 'shapenet' is selected)")
    parser.add_argument('--data_dir', type=str, default="D:\\diffusion\\datasets\\shapenetv2.pc15k\\ShapeNetCore.v2.PC15k",
                        help="Path to the training data")
    parser.add_argument('--mn40_data_dir', type=str, default="D:\\diffusion\\datasets\\shapenetv2.pc15k\\ShapeNetCore.v2.PC15k",
                        help="Path to ModelNet40")
    parser.add_argument('--mn10_data_dir', type=str, default="D:\\diffusion\\datasets\\shapenetv2.pc15k\\ShapeNetCore.v2.PC15k",
    ...
    parser.add_argument("--tr_max_sample_points", type=int, default=5000,
                        help='Max number of sampled points (train)')
    parser.add_argument("--te_max_sample_points", type=int, default=5000,
    ...
    parser.add_argument('--num_sample_points', default=5000, type=int,
